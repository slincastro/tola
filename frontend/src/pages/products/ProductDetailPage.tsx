...
export function ProductDetailPage() {
  ...
  return (
    <section className="space-y-6">
      ...
      <article className="rounded-2xl border border-[#CBB07A]/60 bg-white p-5 shadow-panel">
        <h3 className="text-base font-semibold text-[#1F3A2E]">Metadatos</h3>
        <dl className="mt-4 grid gap-3 text-sm md:grid-cols-2">
          <div className="rounded-xl bg-[#EAF2ED] px-3 py-2">
            <dt className="text-slate-600">ID</dt>
            <dd className="font-semibold text-[#1F3A2E] break-all">{product.id}</dd>
          </div>
          <div className="rounded-xl bg-[#F6F1E5] px-3 py-2">
            <dt className="text-slate-600">Merchant</dt>
            <dd className="font-semibold text-[#1F3A2E]">{product.mid}</dd>
          </div>
          <div className="rounded-xl bg-[#F6F1E5] px-3 py-2">
            <dt className="text-slate-600">Creado</dt>
            <dd className="font-semibold text-[#1F3A2E]">{new Date(product.createdAt).toLocaleString("es-EC")}</dd>
          </div>
          <div className="rounded-xl bg-[#EAF2ED] px-3 py-2">
            <dt className="text-slate-600">Actualizado</dt>
            <dd className="font-semibold text-[#1F3A2E]">{new Date(product.updatedAt).toLocaleString("es-EC")}</dd>
          </div>
        </dl>
      </article>
